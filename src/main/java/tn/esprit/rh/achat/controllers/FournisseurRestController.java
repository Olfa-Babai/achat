...
import tn.esprit.rh.achat.converters.FournisseurConverter;
...
public class FournisseurRestController {
	...
	@Autowired
	FournisseurConverter fournisseurConverter;
	...
	public Fournisseur addFournisseur(@RequestBody FournisseurDTO f) {
		Fournisseur fournisseur =fournisseurConverter.dtoToEntity(f);
	...
	public Fournisseur modifyFournisseur(@RequestBody FournisseurDTO fournisseur) {
		Fournisseur f=fournisseurConverter.dtoToEntity(fournisseur);
